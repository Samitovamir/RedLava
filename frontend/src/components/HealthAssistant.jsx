...
export default function HealthAssistant({ tab = 'activity' }) {
  ...
  function buildContext() {
    ...
    return (
      `Ты ассистент пользователя на странице «Здоровье · ${tabName}». ` +
      (tab === 'activity'
      ...
      'Ты ВИДИШЬ весь контекст дашборда и можешь создавать/переносить события и запоминать факты о пользователе. Отвечай кратко и по делу.' +
