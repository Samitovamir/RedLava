...
const SPORT_CONTEXT =
  'Ты тренер-помощник человека, который занимается триатлоном. По ВСЕМ его данным (тренировки Garmin, ' +
  ...
  'оставляешь пользователю. Без вступлений, без markdown — РОВНО одно предложение.'
...
export default function SportSignal() {
  ...
  return (
    <SignalCard
      ...
      onClick={() => navigate(g ? '/sport' : '/connections')}
    />
  )
}
