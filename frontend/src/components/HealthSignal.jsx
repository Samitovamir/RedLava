...
const HEALTH_CONTEXT =
  'Ты внимательный помощник по здоровью. Человек занимается триатлоном и не имеет медицинского образования. По его данным ' +
  ...
  'когда реально важно. Решение за пользователем. Без вступлений, без markdown — РОВНО одно предложение.'
