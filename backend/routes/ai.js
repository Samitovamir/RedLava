...
router.post('/agent', async (req, res) => {
  ...
  const cachedBody =
    `Ты — личный ассистент пользователя, пожилого русскоязычного человека. Ты РЕАЛЬНО выполняешь задачи, а не только советуешь.\n` +
    ...
    `• ТРЕНИРОВКИ: пользователь любит тренироваться УТРОМ, около 06:30. Когда планируешь тренировку и время не задано — ставь приоритетно на ~06:30, учитывай её длительность и НЕ накладывай на другие события дня. Если 06:30 занято — выбери ближайшее свободное утреннее время. Тип события для тренировок — meeting.\n` +
...
router.post('/read', async (req, res) => {
  ...
  const system =
    'Ты — эрудированный и увлекательный рассказчик, личный помощник пользователя, пожилого русскоязычного человека. ' +
