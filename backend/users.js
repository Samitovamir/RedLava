...
/*
  ...
  Данные аккаунта (календарь, Whoop, Garmin, анализы) изолированы не здесь:
  каждый ключ хранилища несёт id владельца данных, см. userScope.js. Поэтому
  отдельного запрета «не пускать новый аккаунт к данным владельца» не нужно —
  аккаунт физически ходит только в свою ячейку.
*/
